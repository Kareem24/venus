...
function ProService({ service }) {
	...
	return (
		<div className="text-white flex  flex-col md:flex-row gap-7 md:gap-6 border-[1px] border-black-v-700 rounded-xl px-[2.13rem] py-10 hover:bg-blue-bg hover:border-transparent">
